...
#include <xgboost-predictor/tree_model.h>
...
namespace quickscorer {
    ...
    public:
        ...
        static unique_ptr<GBTreeModel> from_xgb_bin(const string &model_path, int num_trees = 0);

        static void expand_children(const vector<xgboost::RegTree::Node> &xgb_nodes,
